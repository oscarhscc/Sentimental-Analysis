...
class JDCommentsCrawler:
    ...
    def __init__(self, productId=None, callback=None, page=1000, score=1, sortType=5, pageSize=10):
    ...
    def save_csv(self, df):
        # 保存文件
        df.to_csv(path_or_buf='jd_xiaomi9_neg.csv', encoding='gbk')
...
def jdComment():
    # 设置关键变量
    page = 100  # 页数
    productId = 7437708  # 商品ID
    callback = 'fetchJSON_comment98vv11357'  # 回调函数
